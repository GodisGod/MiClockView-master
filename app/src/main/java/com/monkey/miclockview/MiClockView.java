...
//        mBackgroundColor = ta.getColor(R.styleable.MiClockView_backgroundColor, Color.parseColor("#237EAD"));
        mBackgroundColor = ta.getColor(R.styleable.MiClockView_backgroundColor, Color.TRANSPARENT);
...
//        mDarkColor = ta.getColor(R.styleable.MiClockView_darkColor, Color.parseColor("#80ffffff"));
        mLightColor = ta.getColor(R.styleable.MiClockView_lightColor, Color.parseColor("#237EAD"));
        mDarkColor = ta.getColor(R.styleable.MiClockView_darkColor, Color.parseColor("#80237EAD"));
